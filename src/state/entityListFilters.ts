...
export const createBasicMigration = (fallbackSort: EntityListSort) => (value: unknown) => {
...
export const migrateStudiesListQueryState = (value: unknown): StudiesListQueryState => {
...
export const migrateLinksListQueryState = (value: unknown): LinksListQueryState => ({
...
export const studiesListQueryAtom = atomWithAsyncStorage<StudiesListQueryState>(
  ...
  { migrate: migrateStudiesListQueryState }
)
export const linksListQueryAtom = atomWithAsyncStorage<LinksListQueryState>(
  ...
  { migrate: migrateLinksListQueryState }
)
...
export const highlightsListQueryAtom = atomWithAsyncStorage<HighlightFilters>(
  ...
  {},
  { migrate: migrateHighlightsListQueryState }
)
...
export const migrateWordAnnotationsListQueryState = (
  value: unknown
  ...
  return {
    ...
    tagId: typeof candidate.tagId === 'string' ? candidate.tagId : null,
    annotationType: ['background', 'underline', 'circle'].includes(String(candidate.annotationType))
...
export const wordAnnotationsListQueryAtom = atomWithAsyncStorage<WordAnnotationsListQueryState>(
  ...
  { migrate: migrateWordAnnotationsListQueryState }
)
