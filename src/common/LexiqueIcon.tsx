...
export interface LexiqueIconProps extends SvgProps {
  color?: string
  size?: number
  theme?: Theme
}

const SvgComponent = ({ color, size, theme: themeProp, ...props }: LexiqueIconProps) => {
  const theme = themeProp!
  return (
    <Svg width={size ?? 22} height={size ?? 22} viewBox="0 0 18 22" {...props}>
      <G id="Page-1" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
        <G id="Group" transform="translate(1.000000, 1.000000)">
          <Path
            ...
            id="Shape"
            stroke={
              theme.colors[color as keyof typeof theme.colors] || color || theme.colors.primary
            }
            strokeWidth={2}
            strokeLinecap="round"
          ...
          <Path
            ...
            id={'\u05D0'}
            fill={theme.colors[color as keyof typeof theme.colors] || color || theme.colors.primary}
            fillRule="nonzero"
          />
          <Path
