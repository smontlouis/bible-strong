...
const MainStack = () => {
  ...
  <PortalProvider>
    ...
    >
      ...
      <MainStackNavigator.Screen name="DictionnaireVerseDetail" component={DictionnaireVerseDetailScreen} />
      ...
      <MainStackNavigator.Screen name="ToggleCompareVerses" component={ToggleCompareVersesScreen} />
      ...
      <MainStackNavigator.Screen name="Timeline" component={TimelineScreen} options={{ gestureEnabled: true }} />
