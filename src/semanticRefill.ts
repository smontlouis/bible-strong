...
const DEFAULT_LEXICON: SemanticRefillLexiconEntry[] = [
  {
    strong: "H7549",
    forms: [["voute"], ["firmament"], ["etendue"], ["voute", "celeste"]],
    priority: "semantic-high",
    source: "semantic-refill:seed",
    evidence: [
      "French references use etendue/firmament for H7549",
      "NBS often renders the concept as voute"
    ],
    confidence: 0.94,
    autoAccept: true
  },
  {
    strong: "H8064",
    forms: [["ciel"], ["cieux"], ["celeste"], ["voute", "celeste"]],
    priority: "semantic-high",
    source: "semantic-refill:seed",
    evidence: [
      "H8064 is the Hebrew sky/heaven term",
      "NBS adjective celeste can carry the same semantic unit in a phrase"
    ],
    confidence: 0.92,
    autoAccept: true
  },
  {
    strong: "H8317",
    forms: [["grouillent"], ["grouiller"], ["foisonnent"], ["pullulent"]],
    priority: "semantic-high",
    source: "semantic-refill:seed",
    evidence: ["H8317 denotes swarming/teeming motion"],
    confidence: 0.9,
    autoAccept: true
  },
  {
    strong: "H8318",
    forms: [["petites", "betes"], ["betes"], ["creatures"], ["animaux"]],
    priority: "semantic-high",
    source: "semantic-refill:seed",
    evidence: ["H8318 denotes swarming creatures in Gen.1.20"],
    confidence: 0.88,
    autoAccept: true
  },
  {
    ...
    source: "semantic-refill:seed",
    evidence: [
      "H1961 is often carried by French existential or becoming phrases"
    ],
    confidence: 0.86,
    autoAccept: true
  },
  {
    strong: "H0120",
    forms: [["humain"], ["humains"], ["etre", "humain"], ["homme"]],
    priority: "semantic-high",
    source: "semantic-refill:seed",
    evidence: ["H0120 denotes humankind/person"],
    confidence: 0.88,
    autoAccept: true
  },
  {
    strong: "H5162",
    forms: [["regrette"], ["regretta"], ["repent"], ["repentir"]],
    priority: "semantic-high",
    source: "semantic-refill:seed",
    evidence: ["H5162 is rendered by repent/regret semantics"],
    confidence: 0.88,
    autoAccept: true
  },
  {
    strong: "H8435",
    forms: [["genealogie"], ["generation"], ["generations"], ["posterite"]],
    priority: "semantic-high",
    source: "semantic-refill:seed",
    evidence: ["H8435 is toledot/generations/genealogy"],
    confidence: 0.88,
    autoAccept: true
  },
  {
    strong: "H5303",
    forms: [["nephilim"], ["geants"]],
    priority: "semantic-high",
    source: "semantic-refill:seed",
    evidence: ["H5303 is the Nephilim/giants term"],
    confidence: 0.9,
    autoAccept: true
  }
];
