...
// Module shim for TypeScript - the UMD bundle assigns to module.exports
declare const _quillExport: any
export default _quillExport
export type { QuillInstance, QuillModule } from './quill-types'
