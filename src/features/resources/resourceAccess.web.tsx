...
import { createHttpCommentaryAccess, type CommentaryAccess } from './commentaryAccess'
...
const bibleVersions = new Set(resourceApiBaseUrl ? PUBLIC_ONLINE_BIBLE_VERSION_IDS : [])
...
const bibleContent = createBibleContentAccess(
  bibleChapter,
  strongBible,
  interlinearBible,
  strongLexicon
...
const commentary = resourceApiBaseUrl
  ? createHttpCommentaryAccess({ baseUrl: resourceApiBaseUrl, isOnline })
