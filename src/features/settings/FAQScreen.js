        ...
        <Box padding={20}>
          ...
          <List.Accordion
            ...
            <Paragraph marginLeft={20} scale={-1}>
              ...
              <InlineLink href="mailto:s.montlouis.calixte@gmail.com"> mail </InlineLink>
              ou de
              <InlineLink href="https://bible-strong.canny.io/bugs"> signaler un bug</InlineLink>.
          ...
          <List.Accordion
            ...
            <Paragraph marginLeft={20} scale={-1}>
              Vous souhaitez une nouvelle version de bible ? Vous avez une idée de fonctionnalité
              intéressante ? Dans ce cas, merci de m'envoyer un
              <InlineLink href="mailto:s.montlouis.calixte@gmail.com"> mail </InlineLink>
              ou de
          ...
          <List.Accordion
            ...
            <Paragraph marginLeft={20} scale={-1}>
              ...
              <InlineLink href="https://www.paypal.me/smontlouis"> paypal </InlineLink> ou{' '}
              <InlineLink href="https://fr.tipeee.com/smontlouis">tipeee</InlineLink>. Si vous
              souhaitez le faire par un autre moyen. Merci de me contacter par
              <InlineLink href="mailto:s.montlouis.calixte@gmail.com"> mail.</InlineLink>
            </Paragraph>
          </List.Accordion>
          <List.Accordion
            ...
            <Paragraph marginLeft={20} scale={-1}>
              <InlineLink href="https://fr.tipeee.com/smontlouis">Tipeee</InlineLink> est une
              plateforme participative pour les créateurs de contenus. Tipeee vous permet de
              soutenir en une fois ou mensuellement. Lorsque vous soutenez quelqu'un mensuellement,
              vous pouvez donner 1€ par mois par exemple. Il suffit de cliquer sur "Tip", de se
