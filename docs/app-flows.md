...
| `/strong` | `StrongMainScreen` | Détail principal d'une entrée Strong. |
...
| `/strong/related` | `StrongRelatedPage` | Mots et identités lexicales liés, dédupliqués par cible. Les autres sens `same_estrong` restent dans SQLite mais sont présentés dans la section « Sens » de la fiche principale. |
