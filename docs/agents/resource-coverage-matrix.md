...
- BHG interlinear publication tests preserve both gloss languages, token/segment alignment offsets,
...
- Mobile adapter tests cover installed-copy priority, zero-copy HTTP, local not-found without source
  ...
  Offline-copy lifecycle used by Nave and the BHG sidecars.
