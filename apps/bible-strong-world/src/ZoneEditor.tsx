...
export default function ZoneEditor({ initial, language, onTest, onSave }: Props) {
  ...
  const [editorState] = useState(() => ({
    ...
    saved: navigationFingerprint(initial),
  ...
  const changed = navigationFingerprint(doc) !== navigationFingerprint(initial)
