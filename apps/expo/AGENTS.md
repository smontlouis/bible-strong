...
For detailed documentation, see the root `../../docs/` folder:
...
Read the root `CONTEXT-MAP.md`, this app's `CONTEXT.md`, and relevant root ADRs before domain work. See `../../docs/agents/domain.md`.
