...
interface DictionnaryIconProps extends SvgProps {
  color?: string
  size?: number
  theme?: Theme
}

const SvgComponent = ({ color, theme: themeProp, size = 22, ...props }: DictionnaryIconProps) => {
      ...
      <G id="Page-1" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
        <G id="Group" transform="translate(1.000000, 1.000000)">
          <Path
            ...
            id="Shape"
            stroke={
              theme.colors[color as keyof typeof theme.colors] || color || theme.colors.secondary
            }
            strokeWidth={2}
            strokeLinecap="round"
