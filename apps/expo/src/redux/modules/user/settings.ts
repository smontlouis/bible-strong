...
export const SET_SETTINGS_RELATIONS_DISPLAY = 'user/SET_SETTINGS_RELATIONS_DISPLAY'
...
export const setSettingsRelationsDisplay = createAction(
  SET_SETTINGS_RELATIONS_DISPLAY,
  (payload: 'inline' | 'block') => ({ payload })
)
...
export const setSettingsInlineCommentariesEnabled = createAction<boolean>(
  'user/SET_SETTINGS_INLINE_COMMENTARIES_ENABLED'
)
