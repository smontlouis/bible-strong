    ...
    >
                        ...
                        >
                          ...
                          >
                            <Box
                              ...
                              style={{ backgroundColor: colorWithOpacity(labelStyle.color, 0.12) }}
                            >
                        ...
                        {showActions => (
                          ...
                          >
                            ...
                            >
                              <Box
                                className="w-[20px] h-[20px] rounded-[5px] items-center justify-center shrink-0"
                                style={{ backgroundColor: colorWithOpacity(iconColor, 0.12) }}
                              >
      ...
      <Box className="border-continuous overflow-hidden px-[12px] pt-[8px] pb-[8px] gap-[4px]">
        ...
        <TouchableBox
          ...
          style={{
            minHeight: rowHeight,
            backgroundColor: activePage === 'settings' ? stylingTheme.colors.reverse : undefined,
            borderRadius: 8,
          }}
        >
