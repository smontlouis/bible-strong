...
import {
  REFERENCE_STRONG_JSONL_SCHEMA_VERSION,
  writeReferenceStrongJsonl
} from "./referenceStrongJsonl.js";

const REFERENCES = [
  { id: "darby", inputPath: "data/strongs/Darby.csv", version: "DARBY" },
  { id: "darbyr", inputPath: "data/strongs/DarbyR.csv", version: "DARBYR" },
  { id: "sg1910", inputPath: "data/strongs/Sg1910.csv", version: "SG1910" }
] as const;
...
async function main(): Promise<void> {
  ...
  await writeFile(
    ...
    `${JSON.stringify(
      {
        artifactSchemaVersion: REFERENCE_STRONG_JSONL_SCHEMA_VERSION,
        format: "jsonl",
        textPolicy: "lossless-inline-markup",
        artifacts
      },
      null,
      2
...
function parseCliOptions(argv: string[]): {
  ...
  return {
    outputDir: args.get("output-dir") ?? "outputs/strong-references-jsonl",
