...
export const OPEN_PASSAGE_MEDIA_SOURCE = 'OPEN_PASSAGE_MEDIA_SOURCE'
...
export const OPEN_ANNOTATION_TAGS = 'OPEN_ANNOTATION_TAGS'
...
export const DOM_COMPONENT_MOUNTED = 'DOM_COMPONENT_MOUNTED'
